...
for i in range(len(station_list)):
    ...
    train_set = new_station_list[:3]
    pool_set = new_station_list[3:]
    ...
    to_csv_df.to_csv('Data/Predicted/'+test_set[0]+'.csv')
#     break
    ...
    plt.tight_layout()
    #plt.savefig('Final_Plots_3/'+station_numbering[station_test[0]]+'.pdf', dpi=300)
    plt.close()
        """
